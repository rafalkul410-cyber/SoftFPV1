###########################################################################
## Makefile generated for component 'FCS'. 
## 
## Makefile     : FCS.mk
## Generated on : Fri Aug 28 11:05:19 2026
...
START_DIR                 = C:/Users/rafal/Desktop/FPVproject/SoftFPV/MBD_FCA_2.0
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
SRCS = $(START_DIR)/FCS_ert_rtw/FCS.c $(START_DIR)/FCS_ert_rtw/FCS_data.c
...
%.obj : $(START_DIR)/FCS_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FCS_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FCS_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
FCS.obj : $(START_DIR)/FCS_ert_rtw/FCS.c
	$(CC) $(CFLAGS) -o "$@" "$<"


FCS_data.obj : $(START_DIR)/FCS_ert_rtw/FCS_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
