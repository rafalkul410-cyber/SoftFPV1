...
typedef struct {
  ...
  real32_T Product2_d[2];              /* '<S458>/Product2' */
  real32_T Product3_m[2];              /* '<S456>/Product3' */
  real32_T Product2_b[2];              /* '<S400>/Product2' */
  real32_T Product3_a[2];              /* '<S398>/Product3' */
  real32_T MemoryX_DSTATE_m[2];        /* '<S404>/MemoryX' */
  real32_T MemoryX_DSTATE_h[2];        /* '<S346>/MemoryX' */
  real32_T Integrator_DSTATE_n[2];     /* '<S265>/Integrator' */
  real32_T Filter_DSTATE[2];           /* '<S260>/Filter' */
  real32_T Integrator_DSTATE_b[2];     /* '<S317>/Integrator' */
  real32_T Filter_DSTATE_e[2];         /* '<S312>/Filter' */
  real32_T Integrator1_DSTATE;         /* '<S403>/Integrator1' */
  real32_T DiscreteTransferFcn_states; /* '<S517>/Discrete Transfer Fcn' */
  real32_T DiscreteTransferFcn_states_e;/* '<S518>/Discrete Transfer Fcn' */
  real32_T DiscreteTransferFcn_states_b;/* '<S519>/Discrete Transfer Fcn' */
  real32_T Integrator1_DSTATE_i;       /* '<S5>/Integrator1' */
  real32_T DiscreteTransferFcn_states_m;/* '<S338>/Discrete Transfer Fcn' */
  real32_T Integrator_DSTATE;          /* '<S9>/Integrator' */
  real32_T DiscreteTransferFcn_states_l;/* '<S515>/Discrete Transfer Fcn' */
  real32_T DiscreteTransferFcn_states_f;/* '<S516>/Discrete Transfer Fcn' */
  real32_T DiscreteTransferFcn_states_bf;/* '<S514>/Discrete Transfer Fcn' */
  real32_T DiscreteTransferFcn_states_li;/* '<S20>/Discrete Transfer Fcn' */
  real32_T DiscreteTransferFcn_states_h;/* '<S19>/Discrete Transfer Fcn' */
  real32_T Integrator5_DSTATE;         /* '<S344>/Integrator5' */
  real32_T Integrator1_DSTATE_a;       /* '<S344>/Integrator1' */
  real32_T Integrator4_DSTATE;         /* '<S344>/Integrator4' */
  real32_T Integrator2_DSTATE;         /* '<S344>/Integrator2' */
  real32_T Filter_DSTATE_k;            /* '<S154>/Filter' */
  real32_T Integrator_DSTATE_m;        /* '<S159>/Integrator' */
  real32_T Filter_DSTATE_p;            /* '<S206>/Filter' */
  real32_T Integrator_DSTATE_c;        /* '<S211>/Integrator' */
...
typedef struct {
  const real32_T Conversion[2];        /* '<S390>/Conversion' */
  const real32_T Conversion_n[2];      /* '<S391>/Conversion' */
  const real32_T Conversion_e[4];      /* '<S393>/Conversion' */
  const real32_T Conversion_i[2];      /* '<S448>/Conversion' */
  const real32_T Conversion_p[2];      /* '<S449>/Conversion' */
  const real32_T Conversion_o[4];      /* '<S451>/Conversion' */
} ConstB;
 ...
 * Block '<S501>/Data Type Conversion3' : Unused code path elimination
